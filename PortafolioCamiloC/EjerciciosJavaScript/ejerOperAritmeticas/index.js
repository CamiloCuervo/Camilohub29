...
function llenarVector(arreglo,tam){
    ...
    document.write('Valores: '+llenarVector(v,x)+"<br>");
//suma de arreglo
sum=vec=>{
    let suma=0;
...
document.write('la suma de los valores del arreglo es:'+sum(v)+"<br>");
...
document.write('el promedio de los valores del array es :' + prom(v,x)+"<br>");
...
document.write('el numero mayor de los valores del arreglo es :'+mayor(v)+"<br>");

//numero menor del array
var min = Math.min(...v) 
console.log('el numero menor de los valores del arreglos es :'+min)
document.write('el numero menor de los valores del arreglos es :'+min+"<br>");
//console.log('el numero menor de los valores del arreglo es :'+menor(v));
//document.write('el numero menor de los valores del arreglo es :'+menor(v)+"<br>");
